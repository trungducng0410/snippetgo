...
import (
	...
	"ducnt.uts/snippetbox/pkg/forms"
	"ducnt.uts/snippetbox/pkg/models"
)
...
func (app *application) signupUser(w http.ResponseWriter, r *http.Request) {
	...
	app.session.Put(r, "flash", "Your signup was successful. Pleas log in.")
...
func (app *application) logoutUser(w http.ResponseWriter, r *http.Request) {
	...
	app.session.Put(r, "flash", "You've been logged out sucessfully!")
